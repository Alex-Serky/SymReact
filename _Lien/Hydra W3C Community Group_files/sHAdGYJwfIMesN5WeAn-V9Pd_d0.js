;window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="63dd30f4b73d0b2696b7dfa4257800cb";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){'use strict'
...
return false}}());CloudflareApps.installs["smg3p1jUnlxX"]={appId:"lMxPPXVOqmoE",scope:{}};;CloudflareApps.installs["smg3p1jUnlxX"].options={"anonymizeIp":false,"id":"UA-42071981-1","social":false};;CloudflareApps.installs["smg3p1jUnlxX"].URLPatterns=["^cookbook.hydra-cg.com/?.*$","^hydra-cg.com/?.*$","^www.hydra-cg.com/?.*$"];;if(CloudflareApps.matchPage(CloudflareApps.installs['smg3p1jUnlxX'].URLPatterns)){(function(){var options=CloudflareApps.installs['smg3p1jUnlxX'].options;var id;if(options.account&&options.organization){id=options["web-properties-for-"+options.organization];}else{id=(options.id||"").trim();}
if(!id){console.log("Cloudflare Google Analytics: Disabled. UA-ID not present.");return;}else if("smg3p1jUnlxX"==="preview"){console.log("Cloudflare Google Analytics: Enabled",id);}
